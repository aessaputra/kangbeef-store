...
class CartResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'sub_total_incl_tax'                 => $this->sub_total_incl_tax ?: $this->items->sum('total_incl_tax'),
            'sub_total'                          => $this->sub_total ?: $this->items->sum('total'),
            'formatted_sub_total_incl_tax'       => core()->formatPrice($this->sub_total_incl_tax ?: $this->items->sum('total_incl_tax')),
            'formatted_sub_total'                => core()->formatPrice($this->sub_total ?: $this->items->sum('total')),
